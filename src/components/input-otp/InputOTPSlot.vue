...
<template>
  <div
    ...
    :class="cn(
      'relative flex size-10 items-center justify-center border-y border-r border-border bg-background text-sm text-foreground shadow-xs transition-all outline-none first:rounded-l-md first:border-l last:rounded-r-md',
